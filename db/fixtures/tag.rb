...
Tag.seed(:id,
  ...
  { :id => 7, :category => "age" , :tag => 30, :name => "30代", :text => "30代を募集中のサークル" },
  { :id => 8, :category => "age" , :tag => 40, :name => "40代", :text => "40代を募集中のサークル" },
  { :id => 9, :category => "age" , :tag => 50, :name => "50代", :text => "50代を募集中のサークル" },
  { :id => 10, :category => "age" , :tag => 60, :name => "60代以上", :text => "60代以上を募集中のサークル" }
