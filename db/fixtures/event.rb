Event.seed(:id,
  ...
  { :id => 5, :category => "スポーツ１", :order => "04", :name => "バドミントン" , :ruby => "badminton",  :openchat => "https://line.me/ti/g2/9hLTdMzYeuiuO1fRinT_wQ", :icon => "fa fa-group" },
  { :id => 9, :category => "スポーツ１", :order => "05", :name => "硬式・軟式テニス" , :ruby => "tennis",  :openchat => "https://line.me/ti/g2/rQkRsdC0Ppg-xVTQVlQYgw", :icon => "fa fa-group" },
  { :id => 10, :category => "スポーツ１", :order => "06", :name => "卓球" , :ruby => "table-tennis",  :openchat => "", :icon => "fa fa-group" }, 
 
  { :id => 7, :category => "スポーツ１", :order => "07", :name => "草野球" , :ruby => "baseball",  :openchat => "https://line.me/ti/g2/StLPRlAGJPjl9rHX9BTXug", :icon => "fa fa-dribbble" },
  { :id => 22, :category => "スポーツ１", :order => "08", :name => "ソフトボール" , :ruby => "softball",  :openchat => "https://line.me/ti/g2/StLPRlAGJPjl9rHX9BTXug", :icon => "fa fa-group" },
  { :id => 16, :category => "スポーツ１", :order => "09", :name => "サッカー" , :ruby => "soccer",  :openchat => "https://line.me/ti/g2/TuGt6TZqgewnQONxcJd7Yw", :icon => "fa fa-soccer-ball-o" },
